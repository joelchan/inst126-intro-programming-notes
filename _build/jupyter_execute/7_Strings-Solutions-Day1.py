...
if a.isnumeric() and b.isnumeric():
    ...
    a_num = int(str(filter(lambda x: x.isnumeric()))
...
# your code
for course in course_codes:
    if : #fill in your boolean expression
        target_courses.append(course)
...
msg = f"Please charge my card for " # complete the f string
print(msg)
